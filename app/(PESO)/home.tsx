      ...
      {loading ? (
        ...
        <>
          ...
          <View style={styles.statsGrid}>
            <TouchableOpacity 
              style={[styles.statCard, styles.statCardAction]}
              onPress={() => router.push("/(PESO)/document_review")}
            >
              <View style={styles.statHeader}>
                <View style={[styles.statIconBg, { backgroundColor: '#FFF4E5' }]}>
                ...
                {stats.pending_documents > 0 && (
                  <View style={styles.badge}>
                    <Text style={styles.badgeText}>{stats.pending_documents}</Text>
                  </View>
                )}
              </View>
              <Text style={styles.statNumber}>{stats.pending_documents}</Text>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statNumber}>{stats.verified_documents}</Text>
              <Text style={styles.statLabel}>Verified Documents</Text>
            </View>
          ...
          <View style={styles.actionsGrid}>
            ...
            >
              ...
              <Text style={styles.actionTitle}>Review Documents</Text>
              <Text style={styles.actionSubtitle}>Check uploaded docs</Text>
            </TouchableOpacity>
