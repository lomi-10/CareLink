    ...
    <SafeAreaView style={s.root} edges={['top']}>
      ...
      <View style={s.header}>
        ...
        <View style={s.headerCenter}>
          ...
          {unreadCount > 0 && (
            <View style={[s.headerBadge, { backgroundColor: theme.color.helper }]}>
        ...
        {unreadCount > 0 ? (
          <TouchableOpacity onPress={markAllRead} style={s.markAllBtn} hitSlop={8}>
            <Text style={[s.markAllText, { color: theme.color.helper }]}>Mark all read</Text>
          </TouchableOpacity>
        ) : <View style={{ width: 90 }} />}
      </View>
...
const s = StyleSheet.create({
  ...
  itemUnread:{ backgroundColor: theme.color.helperSoft + '55' },
