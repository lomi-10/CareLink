...
export const styles = StyleSheet.create({
  ...
  legendText: { fontSize: 11, fontWeight: '600', color: theme.color.muted },
  sheetSection: { marginTop: 12, gap: 4 },
  sheetLabel: { fontSize: 12, fontWeight: '800', color: theme.color.muted, textTransform: 'uppercase' },
  sheetValue: { fontSize: 16, fontWeight: '600', color: theme.color.ink },
  pickerWrap: {
    borderWidth: 1,
    borderColor: theme.color.line,
    borderRadius: 12,
  ...
  previewLine: { fontSize: 14, fontWeight: '700', color: theme.color.ink },
  previewWarn: {
    marginTop: 8,
    fontSize: 13,
    fontWeight: '600',
