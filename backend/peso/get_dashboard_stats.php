...
try {
    ...
    // Dashboard counts — documented definitions:
    // - total_helpers: all registered helpers (users.user_type = helper).
    // - pending_helpers / verified_helpers: from helper_profiles.verification_status (PESO queue alignment).
    // - pending_jobs: job_posts awaiting PESO (status Pending).
    // - total_jobs: currently Open postings (live marketplace).
