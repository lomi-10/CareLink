...
export function createHelperHomeStyles(c: ThemeColor) {
  return StyleSheet.create({
    ...
    qaDesktopTitle: { fontSize: 15, fontWeight: '800', color: c.ink, marginBottom: 4 },
    qaDesktopDesc: { fontSize: 12, color: c.muted, lineHeight: 17 },
    ...
    recruitBannerTitle: { fontSize: 14, fontWeight: '800', color: c.helper, marginBottom: 3 },
    recruitBannerSub: { fontSize: 12, color: c.inkMuted },
