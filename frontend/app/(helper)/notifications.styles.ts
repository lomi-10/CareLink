...
export function createHelperNotificationsStyles(c: ThemeColor) {
  return StyleSheet.create({
    desktopRoot: { flex: 1, flexDirection: 'row', backgroundColor: c.canvasHelper },
    desktopMain: { flex: 1 },
    ...
    itemUnread: { backgroundColor: c.helperSoft + '44' },
