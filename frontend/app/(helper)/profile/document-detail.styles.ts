...
export function createStyles(t: ProfileTheme = makeProfileTheme()) {
  ...
  sideToggleBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, flex: 1, paddingVertical: 9, borderRadius: 10, borderWidth: 1.5, borderColor: '#EDE0D0', backgroundColor: '#FBF3E6' },
  sideToggleBtnActive: { backgroundColor: ORANGE, borderColor: ORANGE },
