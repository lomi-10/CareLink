...
export function createStyles(t: ProfileTheme = makeProfileTheme()) {
  ...
  pillNote:      { fontFamily: FontFamily.fredokaRegular, fontSize: 12, color: '#9A7B5A', lineHeight: 17, marginTop: -6, marginBottom: 12 },
  pillMore:      { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4, marginTop: 12, paddingVertical: 6 },
  pillMoreText:  { fontFamily: FontFamily.fredokaSemiBold, fontSize: 13 },
