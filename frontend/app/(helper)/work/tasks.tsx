...
// PHP: v1/applications/tasks.php (list), helper/work_task_toggle.php (complete toggle), v1/tasks/delete.php
...
import { ORANGE, GREEN, MUTED } from '@/components/helper/home/helperWarmTheme';
...
export default function WorkTasksScreen() {
  ...
  const instructionHeader = (
    <View style={styles.instructionCard}>
      <Ionicons name="information-circle-outline" size={22} color={ORANGE} />
            ...
            return (
              <View style={[styles.row, isDoneSection && styles.rowDone]}>
                <Checkbox
                  ...
                  color={item.status === 'done' ? GREEN : MUTED}
                ...
                {busyId === item.id ? <ActivityIndicator color={ORANGE} /> : null}
              </View>
            );
          }}
        />
