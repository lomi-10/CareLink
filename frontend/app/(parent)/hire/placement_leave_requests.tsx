// app/(parent)/hire/placement_leave_requests.tsx
// PHP: v1/applications/leave-requests.php (list), v1/leave-requests/balance.php, v1/leave-requests/create.php, v1/leave-requests/respond.php (approve/deny)
