// app/(parent)/jobs/post_job.tsx
// PHP: parent/post_job.php (new post), parent/edit_job.php (edit existing), shared/get_categories.php, shared/get_skills.php
  ...
  const formContent = (
    <ScrollView contentContainerStyle={[styles.scrollContent, isDesktop && styles.scrollContentDesktop]}>
      <View style={[styles.formContainer, isDesktop && styles.formContainerDesktop]}>
        ...
        {/* Skills step removed — Category → Job is enough. A job role already implies its skills, and the extra step was a hassle with no real matching benefit. */}
