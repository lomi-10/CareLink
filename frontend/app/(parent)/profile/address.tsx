// app/(parent)/profile/address.tsx
// Address Information detail screen — full address, province, municipality, barangay, landmark.
    ...
    <View style={ds.page}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={ds.bar}>
          ...
          <Text style={ds.barTitle}>Address Information</Text>
        ...
        <ScrollView contentContainerStyle={ds.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={ds.iconHero}>
            <Ionicons name="location" size={32} color={BROWN} />
          </View>
  ...
  return (
    <View style={ds.infoRow}>
      ...
      <View style={ds.infoValueBox}>
        <Text style={ds.infoValue} numberOfLines={3}>{value}</Text>
      </View>
    </View>
  );
}
