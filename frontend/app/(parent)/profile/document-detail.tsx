// app/(parent)/profile/document-detail.tsx
// Document detail view — shown when tapping any document row in documents.tsx.
// PHP: parent/get_profile.php (document data via params from documents.tsx)
...
// considered "Active" (currently in use for verification) — both of those
// final steps complete together.
