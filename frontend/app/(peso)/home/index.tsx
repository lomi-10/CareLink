...
// PHP: peso/get_dashboard_stats.php, peso/get_pending_counts.php
        ...
        <>
          ...
          <View style={styles.statsGrid}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => router.push("/(peso)/users" as never)}
            >
              <View style={styles.statHeader}>
                <View style={[styles.statIconBg, { backgroundColor: '#FFF4E5' }]}>
          ...
          <View style={styles.statsGrid}>
            <TouchableOpacity 
              style={[styles.statCard, styles.statCardAction]}
              onPress={() => router.push("/(peso)/jobs" as never)}
            >
              <View style={styles.statHeader}>
          ...
          <View style={styles.actionsGrid}>
            ...
            <TouchableOpacity 
              style={styles.actionCard}
              onPress={() => router.push("/(peso)/users/create" as never)}
            >
            ...
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => router.push("/(peso)/contracts" as never)}
            >
              <View style={[styles.actionIcon, { backgroundColor: '#E8F5E9' }]}>
