...
export const MOCK_RECOMMENDATIONS: JobPost[] = [
  // Similar structure, 3-5 jobs with high match scores
  {
    job_post_id: "10",
    parent_id: "7",
    title: "Stay-in Yaya for Newborn",
    employment_type: "Stay-in",
    work_schedule: "Full-time",
    salary_offered: 9500,
    salary_period: "Monthly",
...
export const MOCK_APPLICATIONS: Application[] = [ 
  {
    ...
    job_post_id: "1",
    helper_id: "1",
    cover_letter: "Dear Hiring Manager,\n\nI am writing to express my strong interest in the Stay-in Yaya position. With over 3 years of experience in childcare, I am confident in my ability to provide excellent care for your 2-year-old child.\n\nBest regards,\nMaria Santos",
    status: "Shortlisted",
    applied_at: "2 days ago",
    reviewed_at: "1 day ago",
    job_title: "Stay-in Yaya Needed",
